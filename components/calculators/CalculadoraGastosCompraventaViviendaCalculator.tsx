 ...
 */
export default function CalculadoraGastosCompraventaViviendaCalculator() {
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">Los resultados son orientativos. Consulta a un profesional.</p>
          </div>
        </div>
      </div>
    </div>
