...
# Calculateur des "Frais de Transport" (remboursement 50% Navigo)

Calculateur des "Frais de Transport" (remboursement 50% Navigo) est un outil professionnel conçu pour vous aider à calculer de manière précise et rapide. Ce calculateur utilise les réglementations fiscales et les formules les plus récentes pour vous fournir des résultats précis et fiables.
...
1. [Fonte 1](https://www.eurecia.com/blog/remboursement-frais-transport-obligations/)
2. [Fonte 2](https://www.service-public.fr/particuliers/vosdroits/F19846)
3. [Fonte 3](https://mon-entreprise.urssaf.fr/documentation/salari%C3%A9/r%C3%A9mun%C3%A9ration/frais-professionnels/trajets-domicile-travail/transports-publics/montant)
4. [Fonte 4](https://www.mes-allocs.fr/guides/aide-au-transport/aide-au-transport-simulation/)
