...
const calculatorData = {
  ...
  title: "Calculadora de IRPF para profesores particulares autónomos",
  lang: "es",
  tags: "calculadora irpf profesor particular, impuestos clases particulares, modelo 130, iva clases particulares, exencion iva enseñanza, autonomo profesor, fiscalidad profesor",
  inputs: [
    { id: "ingresosTrimestrales", label: "Ingresos trimestrales (exentos de IVA)", type: "number" as const, unit: "€", min: 0, step: 50, tooltip: "Introduce el total facturado por tus clases del trimestre. Recuerda que la enseñanza de materias regladas está exenta de IVA." },
    { id: "gastosDeducibles", label: "Gastos deducibles del trimestre", type: "number" as const, unit: "€", min: 0, step: 20, tooltip: "Suma todos los gastos relacionados con tu actividad: material didáctico, libros, plataformas online, transporte, gestoría, etc." },
    { id: "porcentajeRetencion", label: "Tipo de retención IRPF (si aplica)", type: "select" as const, options: [{ value: 15, label: "15% (General)" }, { value: 7, label: "7% (Nuevos autónomos)" }], tooltip: "Aplica retención solo si facturas a una academia o empresa, no a alumnos particulares." },
    { id: "ingresosConRetencion", label: "Ingresos con retención en el trimestre", type: "number" as const, unit: "€", min: 0, step: 50, tooltip: "Normalmente será 0€. Introduce aquí solo los ingresos de academias u otras empresas que te hayan practicado retención." }
  ],
  outputs: [
    { id: "rendimientoNeto", label: "Rendimiento Neto (Beneficio)", unit: "€" },
    { id: "pagoAdelantado20", label: "Pago a cuenta (20% sobre beneficio)", unit: "€" },
    { id: "retencionesPracticadas", label: "Retenciones ya adelantadas (por academias)", unit: "€" },
    { id: "resultadoModelo130", label: "Resultado a pagar (Modelo 130)", unit: "€" }
  ],
  content: `### Introducción: Claridad Fiscal para tu Vocación
(…testo invariato per brevità…)`,
  seoSchema: {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "¿Tengo que facturar con IVA por mis clases de inglés?", "acceptedAnswer": { "@type": "Answer", "text": "No. Como los idiomas..." } },
      { "@type": "Question", "name": "¿Debo aplicar retención de IRPF en las facturas a mis alumnos?", "acceptedAnswer": { "@type": "Answer", "text": "No. La retención de IRPF solo se aplica..." } },
      { "@type": "Question", "name": "Si no emito facturas con IVA, ¿puedo deducir el IVA de mis gastos?", "acceptedAnswer": { "@type": "Answer", "text": "No. Al realizar una actividad exenta de IVA..." } }
    ]
  }
} as const;
  ...
  const ChartComponent = ({ data, formatCurrency, totalIncome }: { data: any[]; formatCurrency: (value: number) => string; totalIncome: number }) => (
    <mod.ResponsiveContainer width="100%" height="100%">
      <mod.BarChart data={data} layout="vertical" barSize={60}>
        ...
        <mod.Bar dataKey="Impuestos" stackId="a" name="Impuestos (Mod. 130)" />
...
const CalculadoraIrpfProfesoresParticulares: React.FC = () => {
  ...
  const initialStates = {
    ingresosTrimestrales: 4000,
    gastosDeducibles: 750,
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-4 md:p-6 bg-gray-50 font-sans">
        <main className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-md" ref={calculatorRef}>
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">Estima tu IRPF trimestral (Modelo 130) y resuelve las dudas fiscales de tu profesión.</p>
              <div className="text-xs text-sky-800 bg-sky-50 border border-sky-200 rounded-md p-3 mb-6">
                <strong>Consejo Clave:</strong> La enseñanza de materias en planes de estudio oficiales (idiomas, matemáticas, etc.) está <strong>exenta de IVA</strong>. Esto simplifica tu facturación.
              </div>
        ...
        <aside className="lg:col-span-1 space-y-6">
          ...
          <section className="border rounded-lg p-4 bg-white shadow-md">
            <h2 className="font-semibold mb-3 text-gray-800">Guía Fiscal para Profesores</h2>
          ...
          <section className="border rounded-lg p-4 bg-white shadow-md">
            ...
            <ul className="prose prose-sm max-w-none text-gray-700 list-disc pl-5 space-y-2">
              <li>
                <a
                  href="https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/iva-2023/capitulo-6-exenciones-operaciones-interiores/exenciones-ensenanza-formacion-profesional.html"
                  target="_blank" rel="noopener noreferrer nofollow" className="text-indigo-600 hover:underline"
                >
                  Agencia Tributaria: Exenciones de IVA en Enseñanza
                </a>
              </li>
              <li>
                <a
                  href="https://sede.agenciatributaria.gob.es/Sede/ayuda/manuales-videos-folletos/manuales-practicos/irpf-2023/capitulo-8-actividades-economicas-estimacion-directa/pagos-fraccionados-estimacion-directa/obligacion-presentar-pago-fraccionado.html"
                  target="_blank" rel="noopener noreferrer nofollow" className="text-indigo-600 hover:underline"
                >
...
export default CalculadoraIrpfProfesoresParticulares;
