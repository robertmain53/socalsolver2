...
const outputPath = path.join(process.cwd(), 'FORMATTED_REGISTRY_ENTRIES_1101-1300.txt');
fs.writeFileSync(outputPath, formattedEntries, 'utf-8');

console.log(`✅ Saved formatted entries to: FORMATTED_REGISTRY_ENTRIES_1101-1300.txt`);
console.log(`\nTo add to registry:`);
