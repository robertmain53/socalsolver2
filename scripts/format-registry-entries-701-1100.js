...
// Read TSV
const tsvPath = path.join(process.cwd(), 'calculator-missing701-1100.md');
...
const outputPath = path.join(process.cwd(), 'FORMATTED_REGISTRY_ENTRIES_701-1100.txt');
fs.writeFileSync(outputPath, formattedEntries, 'utf-8');

console.log(`✅ Saved formatted entries to: FORMATTED_REGISTRY_ENTRIES_701-1100.txt`);
console.log(`\nTo add to registry:`);
