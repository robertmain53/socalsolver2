...
// Read CSV
const csvPath = path.join(process.cwd(), 'calculator-missing1301-1600.csv');
...
const outputPath = path.join(process.cwd(), 'FORMATTED_REGISTRY_ENTRIES_1301-1600.txt');
fs.writeFileSync(outputPath, formattedEntries, 'utf-8');

console.log(`✅ Saved formatted entries to: FORMATTED_REGISTRY_ENTRIES_1301-1600.txt`);
console.log(`\nTo add to registry:`);
