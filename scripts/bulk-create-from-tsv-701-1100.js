...
/**
 * Bulk create calculators from calculator-missing701-1100.md (TSV format)
...
console.log('\n🚀 Bulk Calculator Creation from TSV (701-1100)\n');
...
const records = parse(tsvContent, {
  ...
  trim: true,
  delimiter: '\t', // TSV uses tabs instead of commas
