      ...
      <div className="space-y-12 sm:space-y-16">
        ...
        <section className="text-center py-12 sm:py-16 bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-400 text-white rounded-xl sm:rounded-2xl shadow-2xl px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl opacity-90 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed">
            Calcolatori professionali gratuiti per fisco, finanza, immobiliare e business
          </p>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            ...
            <h3 className="font-bold text-base sm:text-lg mb-2">Risultati Immediati</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Calcoli istantanei senza attese
            </p>
          </div>

          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            <div className="text-3xl sm:text-4xl mb-3">🔒</div>
            <h3 className="font-bold text-base sm:text-lg mb-2">Privacy Garantita</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Nessun dato salvato o condiviso
            </p>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            ...
            <p className="text-xs sm:text-sm text-gray-600">
              Ottimizzato per ogni dispositivo
            </p>
          </div>

          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            <div className="text-3xl sm:text-4xl mb-3">🆕</div>
            <h3 className="font-bold text-base sm:text-lg mb-2">Sempre Aggiornato</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Normative 2025 incluse
            </p>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
              Scegli la categoria che ti interessa e scopri tutti i calcolatori professionali
              disponibili
            </p>
          </div>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mb-3">
                      {categoryCalcs.length} calcolatori
                    </p>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 sm:p-12 rounded-xl sm:rounded-2xl text-center shadow-2xl">
          ...
          <p className="text-base sm:text-lg opacity-90 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Scegli una categoria e scopri i nostri calcolatori professionali gratuiti
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href={`/${LANG}/${categories[0]?.slug || 'fisco-e-lavoro-autonomo'}`}
