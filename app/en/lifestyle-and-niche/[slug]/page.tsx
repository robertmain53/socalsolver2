...
const CATEGORY = 'lifestyle-and-niche';
const LANG = 'en';
...
async function getContent(slug: string) {
  try {
    const contentPath = path.join(process.cwd(), 'content', 'en', 'lifestyle-and-niche', `${slug}.md`);
...
export default async function CalculatorPage({ params }: Props) {
  ...
  const crumbs = [
      { name: "Home", path: "/en" },
      { name: "Lifestyle & Niche", path: "/en/lifestyle-and-niche" },
      { name: calculatorName }
  ];
