...
const CATEGORY = 'smart-home-and-technology';
const LANG = 'en';
...
async function getContent(slug: string) {
  try {
    const contentPath = path.join(process.cwd(), 'content', 'en', 'smart-home-and-technology', `${slug}.md`);
...
export default async function CalculatorPage({ params }: Props) {
  ...
  const crumbs = [
      { name: "Home", path: "/en" },
      { name: "Smart Home & Technology", path: "/en/smart-home-and-technology" },
      { name: calculatorName }
  ];
