...
export async function generateMetadata() {
  ...
  return generateSEOMetadata({
    title: 'SoCalSolver - Calculadoras Online Profesionales Gratuitas',
      ...
      <div className="space-y-12 sm:space-y-16">
        ...
        <section className="text-center py-12 sm:py-16 bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-400 text-white rounded-xl sm:rounded-2xl shadow-2xl px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl opacity-90 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed">
            Calculadoras profesionales gratuitas para impuestos, finanzas, inmobiliaria y negocios
          </p>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            ...
            <h3 className="font-bold text-base sm:text-lg mb-2">Resultados Inmediatos</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Calculos instantaneos sin esperas
            </p>
          </div>

          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            <div className="text-3xl sm:text-4xl mb-3">&#128274;</div>
            <h3 className="font-bold text-base sm:text-lg mb-2">Privacidad Garantizada</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Ningun dato guardado o compartido
            </p>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg text-center">
            <div className="text-3xl sm:text-4xl mb-3">&#127381;</div>
            <h3 className="font-bold text-base sm:text-lg mb-2">Siempre Actualizado</h3>
            <p className="text-xs sm:text-sm text-gray-600">
              Normativas 2025 incluidas
            </p>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
              Elige la categoria que te interesa y descubre todas las calculadoras profesionales
              disponibles
            </p>
          </div>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mb-3">
                      {categoryCalcs.length} calculadoras
                    </p>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 sm:p-12 rounded-xl sm:rounded-2xl text-center shadow-2xl">
          ...
          <p className="text-base sm:text-lg opacity-90 mb-6 sm:mb-8 max-w-2xl mx-auto">
            Elige una categoria y descubre nuestras calculadoras profesionales gratuitas
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href={`/${LANG}/${categories[0]?.slug || 'impuestos-y-trabajo-autonomo'}`}
